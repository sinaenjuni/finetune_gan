...
def cli_main():
    ...
    acgan = ACGAN.load_from_checkpoint(f"/home/dblab/git/finetuning_gan/src/train/gan/tb_logs/acgan_cifar10_0.01_True_False/version_0/checkpoints/epoch={args.target_model}.ckpt")
